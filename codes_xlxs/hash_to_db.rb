...
hash1 = {:売上高=>[12525, 13155, 14272, 14635], :"支払利息 営業外"=>[-55, -41, -61, -51], :"受取利息 営業外"=>[8, 5, 10, 9], :"税引等調整前当期純利益 "=>[838, 931, 1315, 1293], :研究開発=>[0, 0, 0, 0], :現金=>[1853, 1744, 2087, 2424], :減価償却=>[-9042, -9361, -9641, -10182]}
